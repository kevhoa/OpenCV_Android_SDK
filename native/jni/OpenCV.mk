...
OPENCV_MODULES:=gapi stitching aruco bgsegm bioinspired ccalib dnn_objdetect dnn_superres dpm face fuzzy hfs img_hash intensity_transform line_descriptor mcc quality rapid reg stereo structured_light phase_unwrapping superres optflow surface_matching tracking highgui datasets text plot videostab videoio photo wechat_qrcode xfeatures2d shape ml ximgproc video xobjdetect objdetect calib3d imgcodecs features2d dnn imgproc flann core
